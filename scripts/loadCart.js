      ...
      return this.each(function () {
        ...
        priceBut.onclick = () => {
          if (cartPricesLoaded[0]) {
            ...
            let fiona180180RupeLarcheCart = 0;
            let fiona90180RupeLarcheCart = 0;
            let fionaKosaRupeLarcheCart = 0;
            let fiona180180LarcheCart = 0;
            let fiona90180LarcheCart = 0;
            let fionaKosaLarcheCart = 0;

            for (let i = 0; i < allFences.length; i++) {
              // if (fencesArr[i].color == "grau") {
              if (allFences[i][0].isVisible) fiona180180RupeLarcheCart += 1;
              if (allFences[i][1].isVisible) fiona90180RupeLarcheCart += 1;
            ...
            cartItems = [];
            cartItems.push(
              fiona180180LarcheCart,
              fiona90180LarcheCart,
              fionaKosaLarcheCart,
              fiona180180RupeLarcheCart,
              fiona90180RupeLarcheCart,
              fionaKosaRupeLarcheCart,
              woodenPost190Larche,
              woodenPost95Larche,
