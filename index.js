...
var createScene = function () {
  ...
  var fiona180180RupeArr = [];
  var fiona90180RupeArr = [];
  var fionaKosaDesnaRupeArr = [];
  var fionaKosaLevaRupeArr = [];
  var fiona180180Arr = [];
  var fiona90180Arr = [];
  var fionaKosaDesnaArr = [];
  var fionaKosaLevaArr = [];
  var allFences = [];
  ...
  function changePosAndScaleFence(valueToCount, activeFence) {
    ...
    if (
      fencesArr[activeFence].type == "fiona90180" ||
      fencesArr[activeFence].type == "fionaKosaDesna" ||
      fencesArr[activeFence].type == "fionaKosaLeva" ||
      fencesArr[activeFence].type == "fiona90180Rupe" ||
      fencesArr[activeFence].type == "fionaKosaDesnaRupe" ||
      fencesArr[activeFence].type == "fionaKosaLevaRupe"
    )
  ...
  //MAIN POST MESH //////////////////////////////////////////////////////////////////////////
  BABYLON.SceneLoader.ImportMeshAsync("", "mesh/", "mainPostFiona.glb").then(
    (result) => {
  ...
  var createRightFence = (posX, posZ, rotY, type) =>
    BABYLON.SceneLoader.ImportMeshAsync("", "mesh/", "fionaCombo19.glb").then(
      (result) => {
        ...
        function toActiveFence() {
          ...
          if (fencesArr[activeFence].type == "fiona180180Rupe")
            setActivnesStyle(changeFence, 0, 0, "active-text-color");
          if (fencesArr[activeFence].type == "fiona90180Rupe")
            setActivnesStyle(changeFence, 0, 1, "active-text-color");
          if (fencesArr[activeFence].type == "fionaKosaDesnaRupe")
            setActivnesStyle(changeFence, 0, 2, "active-text-color");
          if (fencesArr[activeFence].type == "fionaKosaLevaRupe")
          ...
          if (fencesArr[activeFence].type == "fiona90180")
            setActivnesStyle(changeFence, 0, 5, "active-text-color");
          if (fencesArr[activeFence].type == "fionaKosaDesna")
            setActivnesStyle(changeFence, 0, 6, "active-text-color");
          if (fencesArr[activeFence].type == "fionaKosaLeva")
        ...
        fakeFence.position = new BABYLON.Vector3(
          getAbsPosX(result.meshes[8]),
          0.9,
          getAbsPosZ(result.meshes[8])
        );
        fakeFence.addRotation(0, rotY, 0);
        fakeFences.push(fakeFence);

        fakeFence.isVisible = false;
        result.meshes[8].addChild(fakeFence);

        //POST CAP
        let rightPostCap = result.meshes[13];
        ...
        //POSTS
        let rightPost = result.meshes[14];
        ...
        //METAL PART TO HOLD WOOD POST
        let rightMetalPart = result.meshes[12];
        rightMetalPart.material = rootMat;
        metalParts.push(rightMetalPart);
        rightMetalParts.push(rightMetalPart);

        //SMALL METAL PART TO HOLD WOOD POST
        let rightSmallMetalPartFront = result.meshes[11];
        let rightSmallMetalPartBack = result.meshes[9];
        let rightSmallMetalPartBoth = result.meshes[10];
        ...
        //WOOD POST
        let rightWoodPost = result.meshes[16];
        ...
        //post roots
        let rightRoot = result.meshes[15];
        if (postType == 0) {
        ...
        //STRUMANKER
        let rightStrVord = result.meshes[17];
        ...
        ///sturmanker Ruck
        let rightStrRuck = result.meshes[18];
        ...
        rightPostCap.addChild(result.meshes[5]);
        rightPostCap.addChild(result.meshes[6]);
        rightPostCap.addChild(result.meshes[7]);
        rightPostCap.addChild(result.meshes[8]);
        ...
        let fiona180180Rupe = result.meshes[8];
        fiona180180RupeArr.push(fiona180180Rupe);
        fiona180180Rupe.isVisible = false;

        let fiona90180Rupe = result.meshes[6];
        fiona90180RupeArr.push(fiona90180Rupe);
        fiona90180Rupe.isVisible = false;

        let fionaKosaDesnaRupe = result.meshes[7];
        fionaKosaDesnaRupeArr.push(fionaKosaDesnaRupe);
        fionaKosaDesnaRupe.isVisible = false;

        let fionaKosaLevaRupe = result.meshes[5];
        fionaKosaLevaRupeArr.push(fionaKosaLevaRupe);
        fionaKosaLevaRupe.isVisible = false;

        let fiona180180 = result.meshes[4];
        fiona180180Arr.push(fiona180180);
        fiona180180.isVisible = false;

        let fiona90180 = result.meshes[3];
        fiona90180Arr.push(fiona90180);
        fiona90180.isVisible = false;

        let fionaKosaDesna = result.meshes[1];
        fionaKosaDesnaArr.push(fionaKosaDesna);
        fionaKosaDesna.isVisible = false;

        let fionaKosaLeva = result.meshes[2];
        fionaKosaLevaArr.push(fionaKosaLeva);
        fionaKosaLeva.isVisible = false;
        ...
        if (type == "fiona180180Rupe") fiona180180Rupe.isVisible = true;

        if (type == "fiona90180Rupe") {
          fiona90180Rupe.isVisible = true;
          setSmallerFenceSize(
            rightPost,
            rightPostCap,
            foundationRight,
        ...
        if (type == "fionaKosaDesnaRupe") {
          fionaKosaDesnaRupe.isVisible = true;
        ...
        if (type == "fionaKosaLevaRupe") {
          fionaKosaLevaRupe.isVisible = true;
          setSmallerFenceSize(
            rightPost,
            rightPostCap,
            foundationRight,
        ...
        if (type == "fiona180180") fiona180180.isVisible = true;

        if (type == "fiona90180") {
          fiona90180.isVisible = true;
          setSmallerFenceSize(
            rightPost,
            rightPostCap,
            foundationRight,
        ...
        if (type == "fionaKosaDesna") {
          fionaKosaDesna.isVisible = true;
          rightWoodPost.scaling.y = 0.524;
          rightWoodPost.position.y = 0.532;
          rightPost.scaling.z = 0.524;
          rightPost.position.y = 0.504;
        ...
        if (type == "fionaKosaLeva") {
          fionaKosaLeva.isVisible = true;
          setSmallerFenceSize(
            rightPost,
            rightPostCap,
            foundationRight,
        ...
        if (type == "fiona180180Rupe" || type == "fiona180180") {
          fenceSizeObj = 180;
        }
        ...
        if (
          ...
          type == "fionaKosaDesna" ||
          type == "fionaKosaLeva" ||
          type == "fionaKosaDesnaRupe" ||
          type == "fionaKosaLevaRupe"
        ) {
          fenceSizeObj = 90;
        }
  ...
  function handleTabActivnes() {
    if (!document.hidden) {
      createRightFence(0.99, 0, 0, "fiona180180Rupe");
  ...
  //ADD NEW FENCES
  let addNewFence180180Rupe = document.getElementById("new-fence-180180-rupe");
  addNewFence180180Rupe.onclick = () => {
    createNewFence(
      createRightFence,
      activeArrowSide,
      rightPosts,
  ...
  let addNewFence90180Rupe = document.getElementById("new-fence-90180-rupe");
  addNewFence90180Rupe.onclick = () => {
    createNewFence(
      createRightFence,
      activeArrowSide,
      rightPosts,
  ...
  let addNewFenceKosaDesnaRupe = document.getElementById(
    "new-fence-kosa-desna-rupe"
  );
  addNewFenceKosaDesnaRupe.onclick = () => {
    createNewFence(
      createRightFence,
      activeArrowSide,
      rightPosts,
  ...
  let addNewFenceKosaLevaRupe = document.getElementById(
    "new-fence-kosa-leva-rupe"
  );
  addNewFenceKosaLevaRupe.onclick = () => {
    createNewFence(
      createRightFence,
      activeArrowSide,
      rightPosts,
  ...
  function changeFenceFunction(c, d, h) {
    ...
    if (d == "fiona180180Rupe") fiona180180RupeArr[h].isVisible = true;

    if (d == "fiona90180Rupe") fiona90180RupeArr[h].isVisible = true;

    if (d == "fionaKosaDesnaRupe") fionaKosaDesnaRupeArr[h].isVisible = true;

    if (d == "fionaKosaLevaRupe") fionaKosaLevaRupeArr[h].isVisible = true;

    if (d == "fiona180180") fiona180180Arr[h].isVisible = true;

    if (d == "fiona90180") fiona90180Arr[h].isVisible = true;

    if (d == "fionaKosaDesna") fionaKosaDesnaArr[h].isVisible = true;

    if (d == "fionaKosaLeva") fionaKosaLevaArr[h].isVisible = true;

    //set fence height///////////////////////////
    if (d == "fionaKosaDesna" || d == "fionaKosaDesnaRupe") {
      //children
      let childType = 0;
      for (let i = 0; i < fencesArr[h].children.length; i++) {
        if (
          fencesArr[fencesArr[h].children[i]].type != "fionaKosaLeva" &&
          fencesArr[fencesArr[h].children[i]].type != "fionaKosaLevaRupe"
        ) {
          childType += 1;
        }
      }
    ...
    if (d == "fionaKosaLeva" || d == "fionaKosaLevaRupe") {
      ...
      if (h > 0 && fencesArr[h].parent != undefined) {
        if (
          fencesArr[fencesArr[h].parent].type == "fionaKosaDesna" ||
          fencesArr[fencesArr[h].parent].type == "fionaKosaDesnaRupe"
        ) {
          let fenceSibling = 0;
          for (
            let i = 0;
  ...
  changeFence[0].addEventListener("click", () => {
    changeFenceFunction(180, "fiona180180Rupe", activeFence);
  });
  changeFence[1].addEventListener("click", () => {
    changeFenceFunction(90, "fiona90180Rupe", activeFence);
  });
  changeFence[2].addEventListener("click", () => {
    changeFenceFunction(90, "fionaKosaDesnaRupe", activeFence);
  });
  changeFence[3].addEventListener("click", () => {
    changeFenceFunction(90, "fionaKosaLevaRupe", activeFence);
  });
  changeFence[4].addEventListener("click", () => {
    changeFenceFunction(180, "fiona180180", activeFence);
  });
  changeFence[5].addEventListener("click", () => {
    changeFenceFunction(90, "fiona90180", activeFence);
  });
  changeFence[6].addEventListener("click", () => {
    changeFenceFunction(90, "fionaKosaDesna", activeFence);
  });
  changeFence[7].addEventListener("click", () => {
    changeFenceFunction(90, "fionaKosaLeva", activeFence);
  });
  ...
  changeAllFences.onclick = () => {
    if (fencesArr[activeFence].type == "fiona180180Rupe") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(180, "fiona180180Rupe", i);
        }
      }
    }
    if (fencesArr[activeFence].type == "fiona90180Rupe") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(90, "fiona90180Rupe", i);
        }
      }
    }
    if (fencesArr[activeFence].type == "fionaKosaDesnaRupe") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(90, "fionaKosaDesnaRupe", i);
        }
      }
    }
    if (fencesArr[activeFence].type == "fionaKosaLevaRupe") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(90, "fionaKosaLevaRupe", i);
        }
      }
    }
    if (fencesArr[activeFence].type == "fiona180180") {
    ...
    if (fencesArr[activeFence].type == "fiona90180") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(90, "fiona90180", i);
        }
      }
    }
    if (fencesArr[activeFence].type == "fionaKosaDesna") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(90, "fionaKosaDesna", i);
        }
      }
    }
    if (fencesArr[activeFence].type == "fionaKosaLeva") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(90, "fionaKosaLeva", i);
        }
      }
    }
